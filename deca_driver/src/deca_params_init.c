...
uint8 chan_idx[NUM_CH_SUPPORTED] = {0, 0, 1, 2, 3, 4, 0, 5};

//-----------------------------------------
uint32 tx_config[NUM_CH] =
{
...
uint8 pll2calcfg = (0x60 | 0x10) ;    /* Bits 7:5 must always be set to binary “011”. Failure to maintain this value will result in DW1000 malfunction. */


//bandwidth configuration
uint8 rx_config[NUM_BW] =
{
    0xD8,   //NBW
    0xBC    //WBW
};
...
uint8 dwnsSFDlen[NUM_BR] = { 0x40, 0x10, 0x08 }; //DW non-standard SFD length for 110k, 850k and 6.81M

// SFD Threshold
uint16 sftsh[NUM_BR][NUM_SFD] =
{
    //110k
    {
...
uint16 dtune1[NUM_PRF] =
{
    0x0087, // 16 MHz PRF
    0x008D //  64 MHz PRF
};

uint32 digital_bb_config[NUM_PRF][NUM_PACS] =
    {
        //16 PRF
        {
            //PAC 8
...
uint16 lde_replicaCoeff[PCODES] = {
